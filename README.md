...
> **Status: Early / Alpha — v0.7.0.** Now with Xbox & Xbox 360 support and a faster, warmer-connection multi-mirror download engine. Still actively being built — expect rough edges, and please file issues.
